...
try:
    from mannequin.TPS.TPSCy import TPSCy as TPSModule
    # import mannequin.TPS.TPSCy as TPSModule
except ImportError:
    from mannequin.TPS import TPSpy as TPSModule
    # import mannequin.TPS.TPSpy as TPSModule
