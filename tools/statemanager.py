...
class AppStateInit(AppState):
    ...
    def build(self):
        self.app.controller_query_query_viewer = ControllerQueryObjectQueryViewer(
            app_state=self)
        self.app.controller_query_sidebar = ControllerQueryObjectModelUploadButton(
            app_state=self)
        self.app.query_model = QueryModel(
            external_controller=self.app.controller_query_query_viewer)
        self.app.controller_query_query_viewer.couple(
            self.app.query_model, self.app.ui.layout.query_image_placeholder)
        self.app.controller_query_sidebar.couple(
            self.app.query_model, self.app.ui.layout.sidebar.button_upload)
...
class AppStateQueryUploaded(AppState):
    def __init__(self, _app, _mediator):
        super(AppStateQueryUploaded, self).__init__(
            _app=_app, _mediator=_mediator)
    ...
    def build(self):
        self.app.ui.layout.sidebar.instructions.configure(
            text=instructions.INSTRUCTIONS_APPLY)
        self.app.controller_query_sidebar.set_app_state(self)
        self.app.ui.layout.query_image_placeholder = QueryImagePlaceholder(
            master=self.app.ui.layout.root)
        self.app.ui.layout.root.bind(
            '<Configure>', self.app.ui.layout.query_image_placeholder.dragging)
        ...
        for i in range(4):
            setattr(self.app.ui.layout, f'retrieved_viewport_{i + 1}',
                    RetrievedViewportPlaceholder(i, '260x260',
                                                 master=self.app.ui.layout.root))
            self.app.ui.layout.root.bind('<Configure>',
                                         partial(getattr(
        ...
        self.app.controller_retrieval_apply.couple(self.app.ui.layout.query_image_placeholder.button_apply,
                                                   self.app.retrieval_model_2d, self.app.retrieval_model_3d)
        self.app.controller_retrieval_apply.bind(
            self.app.controller_retrieval_apply.on_apply)
        self.app.ui.layout.query_image_placeholder.draw(
            self.app.query_model.kind, self.app.query_model.filename)
        self.app.ui.layout.frame_watermark.label.configure(image='')
        self.app.ui.layout.frame_watermark.label.configure(text='')

        self.app.controller_clear.couple(
            None, self.app.ui.layout.sidebar.button_clear_all)
        self.app.controller_clear.bind(
            None, self.app.controller_clear.on_press)
...
class AppStateGarmentSelected(AppState):
    def __init__(self, _app, _mediator):
        super(AppStateGarmentSelected, self).__init__(
            _app=_app, _mediator=_mediator)
        for i in range(4):
        ...
        self.app.relevant_garments_model = RelevantGarmentsModel(
            database_path=self.app.DATABASE_PATH)
        self.app.controller_texture_selection = ControllerTextureSelection(
            app_state=self)
    ...
    def build(self):
        self.app.ui.layout.sidebar.instructions.configure(
            text=instructions.INSTRUCTIONS_SELECT)
        ...
        self.app.controller_pat_preview.couple(
            self.app.pat_model, self.app.ui.layout.frame_pattern_preview)
        self.app.controller_save.couple(
            None, self.app.ui.layout.sidebar.button_save)
        ...
        self.app.controller_pat_preview.bind_(
            'pick_event', self.app.controller_pat_preview.on_pick)
        self.app.controller_pat_preview.bind_(
            'motion_notify_event', self.app.controller_pat_preview.on_hover)
        ...
        self.app.controller_pat_preview.bind_(
            'key_press_event', self.app.controller_pat_preview.on_key_press)
        ...
        self.app.controller_ind_pat_editor = ControllerIndividualPatternEditor(master=self.app.ui.layout.root,
                                                                               app_state=self)
        self.app.controller_ind_pat_editor.couple(
            self.app.pat_model, self.app.ui.layout.frame_pattern_editor)

        self.app.controller_3d_editor_launcher = Controller3DEditorLauncher(
            app_state=self)
        self.app.controller_3d_editor_launcher.couple(
            None, self.app.ui.layout.frame_information.button_launch_editor)
        self.app.controller_3d_editor_launcher.bind(
            self.app.controller_3d_editor_launcher.on_press)
        ...
        self.app.model_selected_texture.set_selected_texture(
            self.app.model_selected_texture.texture_files[0])
        img_default = Image.open(
            self.app.model_selected_texture.selected_texture)
        ...
        self.app.controller_texture_selection.bind(
            None, self.app.controller_texture_selection.on_press_select_texture)
...
class StateManager:
    ...
    def build(self):
        self.__state_instance = StateGenerator.create_state(
            self.__state.value, self.__app, self.__mediator)
